 ...
 */
package com.alipay.sofa.rpc.filter.jaegertracer;
...
import com.alipay.sofa.rpc.module.JeagerTracerModule;
...
public class ProviderTracerFilter extends Filter {
    ...
    public boolean needToLoad(FilterInvoker invoker) {
        return JeagerTracerModule.isEnable();
    }
    ...
    public SofaResponse invoke(FilterInvoker invoker, SofaRequest request) throws SofaRpcException {
        ...
        try {
            serverSpan = GlobalTracer.get().buildSpan("server_receive").start();
            if (serverSpan != null) {
