...
import com.alipay.sofa.rpc.event.JaegerTracerSubscriber;
...
public class JeagerTracerModule implements Module {

    /**
     * Tracer事件订阅
     */
    private JaegerTracerSubscriber subscriber;
    ...
    public static boolean isEnable() {
        ...
        return "jaegerTracer".equals(traceName);
    }
    ...
    @Override
    public void install() {
        Tracer tracer = TracerFactory.getTracer("jaegerTracer");
        if (tracer != null) {
            subscriber = new JaegerTracerSubscriber();
